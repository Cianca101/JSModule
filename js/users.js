...
requestAjax(
    'https://koders1gpython-default-rtdb.firebaseio.com/emmanuel/users/.json',
    showResponse,
    'POST', 
    {
        lastname: "Cianca",
...
// Delete
requestAjax(
    'https://koders1gpython-default-rtdb.firebaseio.com/emmanuel/users/-MQopRAwnV08Gk2OAQ7V.json',
    showResponse,
    'DELETE'
)